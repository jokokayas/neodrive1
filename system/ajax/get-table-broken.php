...
<?php
    ...
    $file = glob("base/data/main/user/$_SESSION[email]/broken/*.json");
...
<div class="table-responsive">
	...
	<?php
        ...
        {
            $kill = explode("/", $files);
            $content = file_get_contents("base/data/main/share/$kill[6]");
            $data = json_decode($content, true);
            $shareid = $data['file']['share_id'];

            if (!empty($data['file']['title'] && $data['file']['status'] == "realbroken"))
            {

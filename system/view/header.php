...
<html lang="en">
   <head>
      ...
      <script async="async" type="text/javascript" src="/js/neodrivev2.5.min.js"></script>
      <script async="async" type="text/javascript" src="/js/get-stats2.5.js"></script>
   ...
   <body id="page-top">
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion toggled" id="accordionSidebar">
         ...
         <li class="nav-item active">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLink" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <div id="collapseLink" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
               <div class="bg-white py-2 collapse-inner rounded">
                  ...
                  <a class="collapse-item" href="/upload-link">Upload Link</a>
                  <a class="collapse-item" href="/upload-folder">Upload Folder</a>
               </div>
            </div>
         </li>
         <!-- Divider -->
...
<a class="dropdown-item d-flex align-items-center" href="#">
         ...
         <?php else:?>
         <img class="img-profile" src="/img/neoo.png">
         <?php endif;?>
      </nav>
